...
*The scraper that refused to die*
...
**The Node version will be deleted.** Not archived — deleted. The Python version in the consolidated platform *is* the continuation.
...
The code isn't precious. The *patterns* are:
...
Filed at `projects/selenium_webdriver/THE_STORY_OF_THIS_REPO.md`.*